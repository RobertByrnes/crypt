                    ...
                    <div class="tab-content d-flex justify-content-center" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active text-align form-new pt-3" id="hashGen-tab">
                            <h3 class="register-heading text-center mb-3">
                                <img src="../tooltip-info.png" class="info" data-toggle="tooltip" data-placement="left" data-html="true" title="Outputs an encrypted string, select an encryption algorithm.">#hashGen
                            </h3>
                        ...
                        <div class="tab-pane fade show text-align form-new pt-3" id="md5Brute-tab">
                            <h3 class="register-heading text-center mb-3">
                                <img src="../tooltip-info.png" class="info" data-toggle="tooltip" data-placement="left" data-html="true" title="Enter a string that has been encrypted with the md5 algorithm e.g. 'c0af77cf8294ff93a5cdb2963ca9f038'. Select the amount of time allowable for the server to exeucute a brute force algorithm to resolve the original string.">md5 Brute
                            </h3>
                            <div class="row register-form">
                                <div class="col-md-12">
                                    ...
                                    <img src="../script_axe.jpg" class="script-axe">
                                    <span class="text-dark">
                        ...
                        <div class="tab-pane fade show text-align form-new pt-3" id="hashBrute-tab">
                            <h3  class="register-heading text-center mb-3">
                                <img src="../tooltip-info.png" class="info" data-toggle="tooltip" data-placement="left" data-html="true" title="Enter an encrypted string and select the encryption method use to encrypt it, otherwise select 'unknown'. This script will use a 'large' dictionary to resolve it to the original string. See the dictionary tab for instruction on how to expand upon the included dictionaries.">#hashBrute
                            </h3>
                            <div class="row register-form">
                                <div class="col-md-12">
                                    <form method="post">
                                    ...
                                    <button type=submit><img src="../script_axe.jpg" class="script-axe"></button>
                                    <div class="progress working mx-auto">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" style="width: 100%"
                        ...
                        <div class="tab-pane fade show text-align form-new pt-3" id="benchmark-tab">
                            <h3  class="register-heading text-center mb-3">
                                <img src="../tooltip-info.png" class="info" data-toggle="tooltip" data-placement="left" data-html="true" title="This script will benchmark your server for adding 'cost' to the PHP password_hash bcrypt algorithm. A higher cost will generate a more secure encryption and will consume greater resources in doing so.  Cost is the amount of iterations over the encryption algorithm.">Benchmark Server
                            </h3>
                            <div class="row register-form">
                                <div class="col-md-12">
                                    <form method="post">
