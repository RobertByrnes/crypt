...
set_time_limit(600);  	/*set_time_limit fuction is used to set the number of seconds a script is allowed to run*/
...
$c_set = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';          /*character set which is used to brute force the password*/
